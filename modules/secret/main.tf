locals {
  ...
  secrets = {
    ...
    "superuser-password"      = var.superuser_password
    "admin-origin"            = var.admin_origin
    "message-broker-username" = var.rabbitmq_username
    "message-broker-password" = var.rabbitmq_password
    "message-broker-host"     = var.rabbitmq_host
    "message-broker-vhost"    = var.rabbitmq_vhost
